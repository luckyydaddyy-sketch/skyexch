...
function AtransactionlistWithdrawl() {
  ...
  const getPageData = async (TYPE: string, PAGE: string, e: any = null) => {
    ...
    let data: any = {
      api: ADMIN_API.ONLINE_PAYMENT.WITHDRAW.GET_LIST,
      value: {
  ...
  const handleStatusChange = async (e: any, item: any, isApprove: boolean) => {
    ...
    setOpen("");
    let data: any = {
      api: ADMIN_API.ONLINE_PAYMENT.WITHDRAW.APPROVE_WITHDRAW,
      // HeaderData?.name === "M"
      //   ? ADMIN_API.ONLINE_PAYMENT.WITHDRAW.APPROVE_WITHDRAW
      //   : ADMIN_API.ONLINE_PAYMENT.WITHDRAW.APPROVE_WITHDRAW_ADMIN,
      value: {
        id: item._id,
        isApprove: isApprove,
      },
...
export default AtransactionlistWithdrawl;
