...
function PremiumDeclare() {
  ...
  const getPageData = async (TYPE: string, PAGE: string, SEARCH: string = '') => {
    let data: any = {
      api: ADMIN_API.SETTING.MANAGE_PREMIUM.GET_LIST,
      value: {
        type: TYPE,
        page: PAGE ? PAGE : '1',
        limit: '50'
    ...
    <div className="container sportleague settings  main_wrap" >
      <div className='top_header'>
        <div className='top_header_title mt-3'>
          <h6 className="font-weight-bold">Manage {tab} Premium <strong>Declare</strong></h6>
        </div>
      </div>
      <div className="tabs">
                  ...
                  <tr key={i}>
                    ...
                    <td>
                      <a onMouseEnter={() => handleMouseEnter(item.name)}
                        ...
                        href={'/cricket/bets/declare/' + item._id + '/manage'}
