...
import { Data, Result } from './interface'


function SessionDeclare() {
  ...
  return (
    <div className="container sportleague settings ">
      <div className='top_header'>
        <div className='top_header_title mt-3'>
          <h6 className="font-weight-bold">Manage {tab} Session <strong>Declare</strong></h6>
        </div>
      </div>
      <div className="tabs">
                  ...
                  <tr key={i}>
                    ...
                    <td>
                      <a onMouseEnter={() => handleMouseEnter(item.name)}
                        ...
                        href={'/session/bets/history/' + item._id + '/manage'}
                        className="btn btn-outline-secondary btn-sm btn_black rollback-result shadow-none">Manage Fancy</a>
                    </td>
                  </tr>
                )
              }) : <h2>No data Found</h2>}
