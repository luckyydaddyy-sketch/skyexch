              ...
              <table id="resultTable" className="table01 margin-table">
                <thead>
                  <tr>
                    ...
                    <th className="light-grey-bg">Player P/L</th>
                    <th className="light-grey-bg">MA Comm.</th>
                    <th className="light-grey-bg">Player AWC Casino Stack</th>
                    <th className="light-grey-bg">Player AWC Casino P/L</th>
                    <th className="light-grey-bg">Upline P/L</th>
                  </tr>
                </thead>
                <tbody>
                      ...
                      return (
                        <>
                          <tr key={item._id}>
                            ...
                            <td className="text-green">{item.comm}</td>
                            ...
                            <td
                              className={
                                item.upLineProfitLost < 0
                                  ? "text-danger"
                                  : "text-green"
                              }
                            >
                              {item.upLineProfitLost}
                            </td>
                          </tr>
                        </>
                      );
                ...
                <tfoot>
                  <tr>
                    ...
                    <th
                      className={
                        pageData?.total?.playerProfitLost < 0
                          ? "text-danger border-top"
                          : "text-green border-top"
                      }
                    >
                      {pageData?.total?.playerProfitLost}
                    </th>
                    <th className="text-green border-top">{pageData?.total?.comm}</th>
                    ...
                    <th
                      className={
                        pageData?.total?.upLineProfitLost < 0
                          ? "text-danger border-top"
                          : "text-green border-top"
                      }
                    >
                      {pageData?.total?.upLineProfitLost}
                    </th>
                  </tr>
                </tfoot>
              </table>
