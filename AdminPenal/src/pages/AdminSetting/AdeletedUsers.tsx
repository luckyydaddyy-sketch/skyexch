    ...
    <div className="container settings full-wrap">
      <div className='top_header'>
        <div className='top_header_title mt-3 d_flex d_flex_justify_spacebt' >
          <h5>Search Deleted Users</h5>
        </div>
        <div style={{ display: "flex", alignItems: "center", marginBottom: "10px" }}>
          <SearchInput outsideBtn placeholder="Enter UserId..." style={{ display: "inline-block" }} searchSubmit={handleSubmit} />
          {/* <div className="search-btn"><button style={{...styleObjectGetBG(DD?.colorSchema, true), height: "30px"}} onClick={handleSubmit}>Search</button></div> */}
          {userID && <div className="search-btn">
            <button
              style={{
