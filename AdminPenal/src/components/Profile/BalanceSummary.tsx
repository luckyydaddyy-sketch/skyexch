  ...
  return (
    <>
      <div className="account_tabs_r">
        <div className="mb-15">
          <strong style={{ fontSize: "16px" }}>Balance Summary</strong>
        </div>
          ...
          >
            ...
            <tbody id="tbdata">
              {true ? (
                <>
                  <tr>
                    <td style={{ width: "100px" }}>Total Deposit</td>
                    <td style={{ width: "150px" }}>0</td>
                  </tr>
                  <tr>
                    <td style={{ width: "100px" }}>Total Withdraw</td>
                    <td style={{ width: "150px" }}>0</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td style={{ width: "100px" }}>Final PL</td>
                    <td style={{ width: "150px" }}>0</td>
                  </tr>
                </>
              ) : (
