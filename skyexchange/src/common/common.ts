...
export const USER_API = {
    ...
    CHANGE_PASSWORD: 'user/auth/changePassword',
    HOME: 'user/home',
    IN_PLAY: 'user/inPlay',
    MULTI_LIST: 'user/multi',
    PIN: 'user/multi/pin',
    PLACE_BET: 'user/sports/placeBet',
    BET_LIST: 'user/sports/betList',
    SEARCH : 'user/sports/search',
    GET_CHANNEL_ID : 'user/sports/getChannelId',
    GET_LIVE_STREAM : 'user/sports/getLiveStream',
    GET_STACK : 'user/getStack',
    UPDATE_STACK : 'user/updateStack',
    GET_BLOCK :'user/sports/getBlockMatch',
    GET_PROFILE : 'user/auth/getProfile',
    MARKET_LIST :'user/home/marketList',
    CASINO_LOGIN : 'user/casino/login',
    ADD_DEPOSIT : 'user/onlinePayment/addDeposit',
    ADD_WITHDRAW : 'user/onlinePayment/addWithdrawal',
    GET_METHOD : 'user/onlinePayment/getMethod',
    GET_WITHDRAWAL_REQUEST : 'user/onlinePayment/getWithdrawalRequest',
    GET_DEPOSIT_REQUEST : 'user/onlinePayment/getDepositRequest',
}
